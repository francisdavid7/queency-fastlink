...
const Footer = () => {
  return (
    <footer className="footer flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-black">
      <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
        <Link to="/">
          <img src="./logo-light.png" width={120} />
        </Link>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li>
              <a href="/">
                Careers
                <span className="text-xs text-white bg-indigo-400 rounded-md ml-2 px-2 py-1">
                  We’re hiring!
                </span>
              </a>
            </li>
      ...
      <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
        <p className="max-w-60">
          Making every customer feel valued—no matter the size of your request.
        </p>
        ...
        <p className="mt-3 text-center">
          © {new Date().getFullYear()} <a href="">Francis David</a>
        </p>
      </div>
    </footer>
  );
