          ...
          >
            <div>
              ...
              <p className="mt-4">
                ...
                traditional education and the practical, hands-on skills
                demanded by the modern workplace.
              </p>
              <p className="mt-4">
                We specialize in delivering top-quality ICT training that
                transforms beginners into competent professionals ready to
                compete globally.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <p className="mt-4">
                We offer a wide range of industry-relevant courses, including
                Web Development, Graphic Design, Office Suite, UI/UX Design,
                Digital Printing, and Digital Branding. Each course is designed
                to provide students with real-world experience through
                project-based learning, mentorship, and exposure to the latest
                tools and trends in the tech industry.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <p className="mt-4">
                ...
                about application. Our instructors combine classroom teaching
                with real-life projects, ensuring that every student gains the
                confidence to solve problems, create digital solutions, and
                think critically.
              </p>

              <p className="mt-4">
                Whether you’re a student seeking a new career path or a business
                professional aiming to upgrade your skills, our training
                programs are structured to help you reach your goals
                efficiently.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <p className="mt-4 mb-8">
                Whether you’re just starting your journey into tech or looking
                to expand your professional capabilities, Queency FastLink is
                your trusted partner for digital transformation. Together, let’s
                build your future in technology — one skill at a time.
              </p>
            </div>
          </motion.div>
        </div>
